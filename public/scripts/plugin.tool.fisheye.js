(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["plugin.tool.fisheye"] = factory(require("g6-for-react"));
	else
		root["plugin.tool.fisheye"] = factory(root["ReactG6"]);
...
var Fisheye = __webpack_require__(398);
  ...
  (0, _createClass3.default)(Plugin, [{
    ...
    value: function init() {
      ...
      graph.on('beforeinit', function () {
        var fisheye = new Fisheye((0, _extends3.default)({
          graph: graph
        }, _this.options));
...
var Tool = function () {
  ...
  (0, _createClass3.default)(Tool, [{
    key: 'zoom',
    value: function zoom(centerx, centery) {
      var graph = this.graph,
          radius = this.radius,
          d = this.d;
      ...
      for (var i = 0; i < size; i += 1) {
        ...
        var dist = (0, _hypot2.default)(node.x - center[0], node.y - center[1]);
        if (dist < radius) {
          // take the center as the origin
          var moved_coords = [node.x - center[0], node.y - center[1]];
          // transform to polar coordinates

          var _Rect2Polar = Rect2Polar(moved_coords[0], moved_coords[1]),
              p = _Rect2Polar.p,
              theta = _Rect2Polar.theta;

          var pf = radius * ((d + 1) * (p / radius) / (d * (p / radius) + 1)); // after fisheye zooming
          // transform to rect coordinates

          var _Polar2Rect = Polar2Rect(pf, theta),
              x = _Polar2Rect.x,
              y = _Polar2Rect.y;
...
function Polar2Rect(p, theta) {
  var x = p * Math.cos(theta);
  var y = p * Math.sin(theta);
  return { x: x, y: y };
}
module.exports = Tool;
