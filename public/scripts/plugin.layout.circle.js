(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["plugin.layout.circle"] = factory(require("g6-for-react"));
	else
		root["plugin.layout.circle"] = factory(root["ReactG6"]);
...
var Layout = __webpack_require__(388);
  ...
  (0, _createClass3.default)(Plugin, [{
    ...
    value: function init() {
      ...
      graph.on('beforeinit', function () {
        var layout = new Layout((0, _extends3.default)({
          graph: graph
        }, _this.options));
